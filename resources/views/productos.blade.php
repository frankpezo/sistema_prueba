                ...
                <div class="card p-2">
                    <div class="card-body mt-4">
                        <div
                            ...
                            <h5><b>REGISTAR PRODUCTOS</b></h5>
                            <a href="{{ route('index') }}" class="btn btn-primary" style="color: #fff">Ir a menú principal </a>
                        </div>

                        <div class="mt-4 ">
                            <form action="{{ route('create.productos') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div
                                    class="d-flex flex-md-row flex-column justify-content-between align-items-md-center align-items-start">
                                    <div style="width: 45%">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nombre del producto"
                                            name="productoNombre" id="nombreProducto" value="{{ old('productoNombre') }}">
                                    </div>
                                    ...
                                    <div style="width: 18%">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control"
                                            placeholder="S/" name="productoPrecio" id="precioProducto"
                                            value="{{ old('productoPrecio') }}">
                                    </div>
                                    ...
                                    <div style="width:
                                        ...
                                        <input type="number" step="1" min="0" class="form-control"
                                            placeholder="0" name="productoStock" id="stockProducto"
                                            value="{{ old('productoStock') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('edit.productos', $producto->id) }}"
                                                class="btn btn-warning">Editar</a>
                                            <form id="deleteForm-{{ $producto->id }}"
                                                action="{{ route('delete.productos', $producto->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button onclick="confirmDelete(event, {{ $producto->id }})" type="submit"
